...
public class InformServiceImpl implements IInformService {
    ...
    public String addInform(String phone, Inform inform) {
        ...
        if (null == user) {
            ...
            if (StringUtils.equals(inform.getType(), NavType.TOPIC.toString())) {
                inform.setViewurl(Constants.VIEWURL_TOPIC + "?id=" + inform.getAssoId());
            ...
            if (StringUtils.equals(inform.getType(), NavType.USER.toString())) {
                ...
                inform.setViewurl(Constants.VIEWURL_USER + "?username=" + informUser.getUsername());
            }
    ...
    public String offline(HttpServletRequest request, Integer id) {
        ...
        Object obj = request.getSession().getAttribute(Constants.ADMINID);
        if (obj == null) {
        ...
        if (StringUtils.equals(inform.getType(), NavType.TOPIC.toString())) {
            ...
            offlineNotice.setC2(new DateTime(topic.getCreateTime()).toString(Constants.DATE_TIME_FMT));
