    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    <li><a id="home_setting" href="home_setting.jsp"><i class="fa fa-angle-double-right"></i>首页设置</a>
                    </li>
                    <li><a id="report_manage" href="report_manage.jsp"><i class="fa fa-angle-double-right"></i>举报管理</a>
                    </li>
                    <li><a id="circle_list" href="circle_list.jsp"><i class="fa fa-angle-double-right"></i>圈子管理</a></li>
                    ...
                    <li><a id="new_manage" href="new_manage.jsp"><i class="fa fa-angle-double-right"></i>资讯管理</a></li>
                </ul>
            </li>
        </ul>
        <!-- 侧边菜单 end -->
