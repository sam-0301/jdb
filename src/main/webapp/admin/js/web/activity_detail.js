...
function bindData() {
    ...
    $("#activity-detail").html(
        ...
        "<li><span>报名结束时间：</span>" + obj.data.closeTime + "</li>" +
        "</ul>" +
        ...
        "<li><span>人数上限：</span>" + obj.data.personLimit + "</li>" +
        "</ul>" +
        "</div>" +
        "<div class=\"group-detdil\">" +
        "<span>图片：</span>" +
        ...
        "<div class=\"group-detdil\">" +
        "<span>核心话题：</span>" +
        "<p class=\"content\">" + obj.data.topic + "</p>" +
        "</div>" +
        "<div class=\"group-detdil\">" +
        "<ul>" +
        ...
        "<div class=\"group-detdil\">" +
        "<span>其他：</span>" +
        "<p class=\"content\">" + obj.data.otherInfo + "</p>" +
        "</div>" +
        "<div class=\"group-detdil\">" +
        "<ul class=\"detdilLeft fl\">" +
