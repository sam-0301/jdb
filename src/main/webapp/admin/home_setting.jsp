                ...
                <div class="admin-bd">
                    <div class="home">
                        <div class="homeSetting">
                            ...
                            <form id="newsAndAtvsForm" name="newsAndAtvsForm" method="post"
                            ...
                            <div class="homeWord">
                                ...
                                <div class="gx-submit-btn">
                                    <button id="rebackNewsAtvBtn" class="gx-button gx-button-success">还原</button>
                                    <button id="publishNewsAtvBtn" class="gx-button gx-button-error">发布</button>
                                </div>
                            </div>
                        </div>
